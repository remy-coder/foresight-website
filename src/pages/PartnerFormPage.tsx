...
export default function PartnerFormPage({ onNavigate }: PartnerFormPageProps) {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/mqegprpz', {
        method: 'POST',
        body: formData,
        headers: {
        ...
        <div className="max-w-xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-500 font-display font-medium leading-relaxed">
              Your partnership enquiry has been sent to Foresight Australia.
            </p>
            <button
    ...
    <div className="pt-14 pb-8 md:pt-20 md:pb-14 bg-[#FAFAFA]">
      <div className="max-w-7xl mx-auto px-4 sm:px-4 lg:px-6">
        ...
        <div className="max-w-3xl mb-12 md:mb-16">
          ...
          >
            Partner with <span className="text-primary">Foresight Australia</span>.
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Foresight Australia works with local hospitals, governments, universities, NGOs, Rotary clubs, funders and community organisations to build sustainable eye care systems. Please complete the form below and we will contact you.
          </motion.p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="space-y-2">
                  <label className="text-[11px] font-display font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Organisation Name</label>
                  <input required name="organisationName" type="text" className="w-full px-4 py-4 md:px-6 md:py-5 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all font-display font-bold text-gray-900 placeholder:font-medium placeholder:text-gray-400" placeholder="Organisation Name" />
                </div>
                <div className="space-y-2">
                  <label className="text-[11px] font-display font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Contact Name</label>
                  <input required name="contactName" type="text" className="w-full px-4 py-4 md:px-6 md:py-5 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all font-display font-bold text-gray-900 placeholder:font-medium placeholder:text-gray-400" placeholder="Full Name" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="space-y-2">
                  ...
                  <input required name="email" type="email" className="w-full px-4 py-4 md:px-6 md:py-5 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all font-display font-bold text-gray-900 placeholder:font-medium placeholder:text-gray-400" placeholder="email@organisation.com" />
                </div>
                <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="space-y-2">
                  <label className="text-[11px] font-display font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Organisation Type</label>
                  <select required name="organisationType" className="w-full px-4 py-4 md:px-6 md:py-5 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all font-display font-bold text-gray-900">
                ...
                <div className="space-y-2">
                  ...
                  <input required name="interest" type="text" className="w-full px-4 py-4 md:px-6 md:py-5 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all font-display font-bold text-gray-900 placeholder:font-medium placeholder:text-gray-400" placeholder="e.g. Clinical Partnerships, Funding" />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-[11px] font-display font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Message</label>
                <textarea required name="message" rows={4} className="w-full px-4 py-4 md:px-6 md:py-5 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all font-display font-bold text-gray-900 resize-none placeholder:font-medium placeholder:text-gray-400" placeholder="Tell us more about how you would like to partner..."></textarea>
              </div>
