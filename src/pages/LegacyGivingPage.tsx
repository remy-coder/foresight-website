...
interface LegacyGivingPageProps {
  onNavigate?: (id: string) => void;
}

export default function LegacyGivingPage({ onNavigate }: LegacyGivingPageProps) {
        ...
        <div className="max-w-xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-500 font-display font-medium leading-relaxed">
              Your request has been sent to Foresight Australia.
            </p>
            <button
    ...
    <div className="pt-14 pb-8 md:pt-20 md:pb-14 bg-[#FAFAFA]">
      <div className="max-w-7xl mx-auto px-4 sm:px-4 lg:px-6">
        ...
        <div className="max-w-3xl mb-12 md:mb-16">
          ...
          >
            Legacy Giving <span className="text-primary">Information Pack</span>.
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Leaving a gift in your Will is a meaningful way to help Foresight Australia continue restoring sight and preventing avoidable blindness for future generations. Please complete the form below and we will contact you.
          </motion.p>
        </div>
        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            {error && (
              <div className="mb-8 p-6 bg-red-50 border border-red-100 rounded-2xl flex items-center gap-4 text-red-600">
                ...
                <p className="text-sm font-display font-bold">
                  Sorry, your request could not be sent. Please email us directly at <a href="mailto:foresight@foresight.org.au" className="underline hover:text-red-700 transition-colors">foresight@foresight.org.au</a>.
                </p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8 relative z-10">
              ...
              <input type="hidden" name="subject" value="Legacy giving information pack request" />
              ...
              <div className="space-y-2">
                <label className="text-[11px] font-display font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Postal Address</label>
                <textarea required name="postalAddress" rows={3} className="w-full px-4 py-4 md:px-6 md:py-5 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all font-display font-bold text-gray-900 resize-none placeholder:font-medium placeholder:text-gray-400" placeholder="Street Address, City, State, Postcode"></textarea>
              </div>

              <div className="space-y-2">
                <label className="text-[11px] font-display font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Message (Optional)</label>
                <textarea name="message" rows={4} className="w-full px-4 py-4 md:px-6 md:py-5 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all font-display font-bold text-gray-900 resize-none placeholder:font-medium placeholder:text-gray-400" placeholder="Any specific questions or information you would like?"></textarea>
              </div>
              ...
              <div className="pt-4">
                ...
                >
                  {submitting ? 'Sending...' : 'Request Information Pack'}
                </button>
